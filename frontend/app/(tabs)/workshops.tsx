...
const mockWorkshops: Workshop[] = [
  ...
  },
  {
    ...
    description: 'Get your hands dirty and learn the fundamentals of pottery making, from centering clay to basic glazing techniques.',
    ...
    time: '1:00 PM',
    duration: '4 hours',
    location: 'Pottery Studio East',
    price: 85,
    maxParticipants: 15,
    currentParticipants: 7,
    difficulty: 'Beginner',
    image: 'https://images.pexels.com/photos/1117481/pexels-photo-1117481.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop',
    materials: ['Clay', 'Tools', 'Glazes', 'Apron'],
    rating: 4.6,
    reviews: 12
  },
  {
    ...
    description: 'Learn traditional basket weaving techniques using natural materials. Create your own functional basket to take home.',
    ...
    time: '9:00 AM',
    duration: '6 hours',
    location: 'Craft Workshop Center',
    price: 110,
    maxParticipants: 10,
    currentParticipants: 4,
    difficulty: 'Intermediate',
    image: 'https://images.pexels.com/photos/4792065/pexels-photo-4792065.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop',
    materials: ['Reed', 'Willow', 'Basic tools', 'Clips'],
    rating: 4.9,
    reviews: 8
  }
];
        ...
        <View style={styles.feedContainer}>
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            <View style={styles.content}>
              <Text style={styles.pageTitle}>Available Workshops</Text>
              <Text style={styles.pageSubtitle}>
                Discover and book creative workshops from talented crafters in your community.
              </Text>
